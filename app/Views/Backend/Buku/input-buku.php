...
<div class="row bg-white mt-3 mb-3 ms-4 me-4 rounded border border-1 shadow">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">Input Buku</h1>

                <div class="container bg-white mt-3 p-4 rounded shadow-sm border" style="max-width: 1000px;">
        <form method="post" action="<?= base_url('admin/simpan-data-buku'); ?>" enctype="multipart/form-data">
            <div class="row">
                <!-- Gambar Sampul Buku -->
                <div class="col-md-4 text-center">
                    <div id="cover-preview" class="mb-3">
                        <img id="coverImage" src="/assets/logo_buku.png" alt="Cover Buku" class="img-thumbnail" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control" id="cover_buku" name="cover_buku" required accept=".jpg, .jpeg, .png" onchange="previewCover()">
                        </div>
