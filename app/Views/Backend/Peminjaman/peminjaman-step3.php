    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Peminjaman Fase 3</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row bg-white mt-3 mb-3 mx-4 rounded border shadow">
        <div class="card w-100">
            <div class="card-body">
                ...
                <?php if ($jumlahTemp > 0): ?>
                    <form id="formPeminjaman" action="<?= base_url('admin/simpan-transaksi-peminjaman') ?>" method="post">
                        ...
                        <div class="text-start mt-3">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmationModal">Simpan Peminjaman</button>
                        </div>
                    </form>
                <?php else: ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmationModalLabel">Konfirmasi Simpan Peminjaman</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Apakah Anda yakin ingin menambah peminjaman buku ini?
                </div>
