          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <form action="<?= base_url('admin/autentikasi-login');?>" method="post" class="row g-3 needs-validation" novalidate>
                  ...
                  <div class="col-12">
                    ...
                    <input type="password" name="password" class="form-control" id="yourPassword" required minlength="8" title="Password harus terdiri minimal 8 karakter">
...
<div class="modal-dialog modal-dialog-centered">
  ...
  <script>
    <?php if (session()->getFlashdata('error')): ?>
        document.getElementById('modalMessage').textContent = "<?php echo session()->getFlashdata('error'); ?>";
        var myModal = new bootstrap.Modal(document.getElementById('statusModal'));
        myModal.show();
    <?php endif; ?>

    <?php if (session()->getFlashdata('success')): ?>
        document.getElementById('modalMessage').textContent = "<?php echo session()->getFlashdata('success'); ?>";
        var myModal = new bootstrap.Modal(document.getElementById('statusModal'));
        myModal.show();
    <?php endif; ?>
</script>
