<main id="main" class="main">
    ...
    <div class="row bg-light rounded border shadow-sm p-4">
        <div class="col-12 col-lg-6">
            ...
            <form method="post" action="<?= base_url('user/peminjaman-step1'); ?>">
                <div class="mb-2">
            ...
            <div class="w-100 mb-4">
                <table>
                    <tr>
                        ...
                        <td><h6 class="text-black-50"><b><?= isset($user['nama_anggota']) ? $user['nama_anggota'] : 'Data tidak tersedia'; ?></b></h6></td>
                    </tr>
                    <tr>
                        <td><h6 class="text-black-50">Email</h6></td>
                        <td class="text-center"><h6 class="text-black-50">:</h6></td>
                        <td><h6 class="text-black-50"><?= isset($user['email']) ? $user['email'] : 'Data tidak tersedia'; ?></h6></td>
                    </tr>
                    <tr>
                        <td><h6 class="text-black-50">Nomor telepon</h6></td>
                        <td class="text-center"><h6 class="text-black-50">:</h6></td>
                        <td><h6 class="text-black-50"><?= isset($user['no_tlp']) ? $user['no_tlp'] : 'Data tidak tersedia'; ?></h6></td>
                    </tr>
                    <tr>
                        <td><h6 class="text-black-50">Alamat</h6></td>
                        <td class="text-center"><h6 class="text-black-50">:</h6></td>
                        <td><h6 class="text-black-50"><?= isset($user['alamat']) ? $user['alamat'] : 'Data tidak tersedia'; ?></h6></td>
                    </tr>
                    <tr>
                        ...
                        <td><h6 class="text-black-50">
                            ...
                            if (isset($user['jenis_kelamin'])) {
                                echo $user['jenis_kelamin'] == 'L' ? 'Laki-laki' : ($user['jenis_kelamin'] == 'P' ? 'Perempuan' : 'Data tidak tersedia');
                            } else {
                    ...
                    <div class="card shadow-sm d-flex flex-row align-items-center book-card">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                <a href="<?= base_url('user/peminjaman-step2'); ?>" class="btn btn-primary me-2">Konfirmasi</a>
    ...
    <form id="bookForm" action="<?= base_url('user/simpan-temp-pinjam'); ?>" method="post">
        <?= csrf_field(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($data['jumlah_buku'] != "0"): ?>
                                    <a href="<?= base_url('user/simpan-temp-pinjam') . "/" . sha1($data['id_buku']); ?>">
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.delete-btn').forEach(function (button) {
        button.addEventListener('click', function (event) {
            ...
            document.getElementById('confirmDeleteBtn').setAttribute('href', '/user/hapus-temp-pinjam/' + bookId);
