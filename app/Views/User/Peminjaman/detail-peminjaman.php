<main id="main" class="main">
    ...
    <?php elseif ($detail_peminjaman['status_transaksi'] == 'Menunggu Konfirmasi'): ?>
    ...
    <?php endif; ?>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm p-4 bg-white rounded text-center">
                        ...
                        <p>
                            <?php
                            if ($detail_peminjaman['status_transaksi'] == 'Selesai') {
    ...
    <div class="d-flex justify-content-end mt-4">
        <a href="<?= base_url('user/peminjaman'); ?>" class="btn btn-secondary me-2">Kembali</a>
        <?php if ($detail_peminjaman['status_transaksi'] != 'Selesai' && $detail_peminjaman['status_transaksi'] != 'Menunggu Konfirmasi'): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="confirmationModalLabel">Konfirmasi Pengembalian Buku</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('user/proses-pengembalian/' . $detail_peminjaman['id_peminjaman']); ?>" class="btn btn-success">Kembalikan</a>
                </div>
            </div>
        </div>
    </div>
