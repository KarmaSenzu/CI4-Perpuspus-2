<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url('user/denda'); ?>">Denda</a></li>
  ...
  <div class="card shadow-sm p-4 bg-white rounded mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <?php if ($denda - $denda_dibayar > 0): ?>
          <form action="<?= base_url('user/bayar-denda/' . $detail_peminjaman['id_peminjaman']); ?>" method="post">
            <div class="mb-3">
    ...
    <div class="mt-3">
      <a href="<?= base_url('user/denda-user'); ?>" class="btn btn-secondary">Kembali</a>
    </div>
