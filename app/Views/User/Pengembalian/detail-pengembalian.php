        ...
        <div class="col-md-6">
            ...
            <div class="w-100 mb-4">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td><h6 class="text-black-50">Kategori</h6></td>
                        <td class="text-center"><h6 class="text-black-50">:</h6></td>
                        <td><h6 class="text-black-50"><?= isset($detail_pengembalian['nama_kategori']) ? $detail_pengembalian['nama_kategori'] : 'Data tidak tersedia'; ?></h6></td>
                    </tr>
                </table>
            </div>
        </div>
...
<div class="col-md-3 d-flex align-items-stretch">
    <div class="card shadow-sm p-4 bg-white rounded text-center d-flex flex-column justify-content-center align-items-center w-100">
        ...
        <div class="d-flex justify-content-end mt-4">
            <a href="<?= base_url('user/pengembalian'); ?>" class="btn btn-secondary me-2">Kembali</a>
        </div>
    </div>
</main>
